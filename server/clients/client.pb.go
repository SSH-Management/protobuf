...
import (
	common "github.com/SSH-Management/protobuf/common"
...
type CreateClientRequest struct {
	...
	Name  string `protobuf:"bytes,1,opt,name=name,proto3" json:"name,omitempty" conform:"trim" validate:"required,max=50"`
	Ip    string `protobuf:"bytes,2,opt,name=ip,proto3" json:"ip,omitempty" conform:"trim" validate:"required,ip,max=30"`
	Group string `protobuf:"bytes,3,opt,name=group,proto3" json:"group,omitempty" validate:"required,max=50" conform:"trim"`
}
...
type CreateClientResponse struct {
	...
	Users     []*common.LinuxUser `protobuf:"bytes,2,rep,name=users,proto3" json:"users,omitempty"`
...
var file_clients_client_proto_rawDesc = []byte{
	...
	,
	...
	,
	...
	0x65, 0x12, 0x23, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x65, 0x72, 0x2e, 0x63, 0x6c, 0x69, 0x65, 0x6e,
	...
	0x5a, 0x31, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x53, 0x53, 0x48,
	0x2d, 0x4d, 0x61, 0x6e, 0x61, 0x67, 0x65, 0x6d, 0x65, 0x6e, 0x74, 0x2f, 0x70, 0x72, 0x6f, 0x74,
	0x6f, 0x62, 0x75, 0x66, 0x2f, 0x73, 0x65, 0x72, 0x76, 0x65, 0x72, 0x2f, 0x63, 0x6c, 0x69, 0x65,
...
var file_clients_client_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_clients_client_proto_goTypes = []interface{}{
	(*CreateClientRequest)(nil),  // 0: server.clients.CreateClientRequest
	(*CreateClientResponse)(nil), // 1: server.clients.CreateClientResponse
	(*DeleteClientRequest)(nil),  // 2: server.clients.DeleteClientRequest
	(*common.LinuxUser)(nil),     // 3: common.LinuxUser
	(*emptypb.Empty)(nil),        // 4: google.protobuf.Empty
}
var file_clients_client_proto_depIdxs = []int32{
	3, // 0: server.clients.CreateClientResponse.users:type_name -> common.LinuxUser
	0, // 1: server.clients.ClientService.Create:input_type -> server.clients.CreateClientRequest
	2, // 2: server.clients.ClientService.Delete:input_type -> server.clients.DeleteClientRequest
	1, // 3: server.clients.ClientService.Create:output_type -> server.clients.CreateClientResponse
	4, // 4: server.clients.ClientService.Delete:output_type -> google.protobuf.Empty
